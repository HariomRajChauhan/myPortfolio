...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 border-t border-white/5 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Computer Engineering student blending technical expertise with creative design 
        ...
        <div className="mt-4 text-center">
          <p className="text-gray-600 text-xs">
            Built with 💜 using React, Node.js & TailwindCSS
          </p>
        </div>
      </div>
    </footer>
